    ...
    public class StmtGenerateBinary
    {
        ...
        public void StmtGenerateBinaryTest()
        {
            TestCase[] testCases = new TestCase[]
            {
                    ...
                    BindData = new BindData[]
                    {
                        new BindData
                        {
                            ...
                            Rows = new object[][]
                            {
                                new object[]
                                {
                                    TDengineConstant.ConvertTimestampToDateTime(1726803356466, TDenginePrecision.TSDB_TIME_PRECISION_MILLI,TimeZoneInfo.Utc),
                                    true,
                                    (sbyte)11,
                                    (short)11,
                                    (int)11,
				...
				// buffer length
				0x1c, 0x00, 0x00, 0x00,
				0x32, 0x30, 0x32, 0x34, 0x2d, 0x30, 0x39, 0x2d, 0x32, 0x30, 0x54, 0x30, 0x33, 0x3a, 0x33, 0x35, 0x3a, 0x35, 0x36, 0x2e, 0x34, 0x36, 0x36, 0x30, 0x30, 0x30, 0x30, 0x5a,
