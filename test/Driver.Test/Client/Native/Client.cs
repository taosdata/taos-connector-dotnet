...
namespace Driver.Test.Client.Native
{
    public class Client
    {
        ...
        [Fact]
        public void TDengineNativeDriverTest()
        {
            var db = "driver_test";
        ...
        [Fact]
        public void TDengineNativeDriverNanoTest()
        {
            var db = "driver_test_ns";
            Random rand = new Random();
            bool v1 = true;
            sbyte v2 = (sbyte)rand.Next(sbyte.MinValue, sbyte.MaxValue);
            short v3 = (short)rand.Next(short.MinValue, short.MaxValue);
        ...
        [Fact]
        public void TDengineNativeDriverNanoReqTest()
        {
            var db = "driver_test_ns_req";
            Random rand = new Random();
            bool v1 = true;
            sbyte v2 = (sbyte)rand.Next(sbyte.MinValue, sbyte.MaxValue);
            short v3 = (short)rand.Next(short.MinValue, short.MaxValue);
        ...
        [Fact]
        public void TDengineNativeStmtTest()
        {
            var db = "stmt_test";
            Random rand = new Random();
            bool v1 = true;
        ...
        [Fact]
        public void TDengineNativeStmtNanoTest()
        {
            var db = "stmt_test_nano";
            Random rand = new Random();
            bool v1 = true;
            sbyte v2 = (sbyte)rand.Next(sbyte.MinValue, sbyte.MaxValue);
            short v3 = (short)rand.Next(short.MinValue, short.MaxValue);
            ...
            using (var client = DbDriver.Open(builder))
            {
                try
                {
                    ...
                    Assert.True(isInsert);
                    stmt.SetTableName("t1");
                    var colField = stmt.GetColFields();
                    Assert.Equal(14,colField.Length);
                    ...
                    using (var result = stmt.Result())
                    {
                        ...
                        Assert.True(haveNext);
                        Assert.Equal(
                            TDengineConstant.ConvertTimeToDatetime(nextSecondTs,
                                TDenginePrecision.TSDB_TIME_PRECISION_NANO), result.GetValue(0));
                        for (int i = 1; i < 13; i++)
                        {
                            Assert.Null(result.GetValue(i));
                        }
        ...
        [Fact]
        public void TDengineNativeStmtNanoReqTest()
        {
            var db = "stmt_test_nano_req";
            Random rand = new Random();
            bool v1 = true;
            sbyte v2 = (sbyte)rand.Next(sbyte.MinValue, sbyte.MaxValue);
            short v3 = (short)rand.Next(short.MinValue, short.MaxValue);
        ...
        [Fact]
        public void TDengineNativeStmtBindColumnsTest()
        {
            var db = "stmt_test_columns";
            Random rand = new Random();
            bool v1 = true;
            sbyte v2 = 1;
            short v3 = -13084;
            ...
            bool vv1 = true;
            sbyte vv2 = (sbyte)rand.Next(sbyte.MinValue, sbyte.MaxValue);
            short vv3 = (short)rand.Next(short.MinValue, short.MaxValue);
            int vv4 = rand.Next();
            long vv5 = rand.Next();
            byte vv6 = (byte)rand.Next(byte.MinValue, byte.MaxValue);
            ushort vv7 = (ushort)rand.Next(ushort.MinValue, ushort.MaxValue);
            uint vv8 = (uint)rand.Next();
            ulong vv9 = (ulong)rand.Next();
            float vv10 = (float)rand.NextDouble();
            double vv11 = rand.NextDouble();
            ...
            using (var client = DbDriver.Open(builder))
            {
                try
                {
                    ...
                    var a1 = new bool?[] { v1, null,vv1, };
                    var a2 = new sbyte?[] { v2, null,vv2 };
                    var a3 = new short?[] { v3, null,vv3 };
                    var a4 = new int?[] { v4, null,vv4 };
                    var a5 = new long?[] { v5, null,vv5 };
                    var a6 = new byte?[] { v6, null,vv6 };
                    var a7 = new ushort?[] { v7, null,vv7 };
                    var a8 = new uint?[]{v8,null,vv8};
                    ...
                    using (var result = stmt.Result())
                    {
                        ...
                        Assert.Equal(
                            TDengineConstant.ConvertTimeToDatetime(next2SecondTs, TDenginePrecision.TSDB_TIME_PRECISION_NANO),
                            result.GetValue(0));
                        Assert.Equal(vv1, (bool)result.GetValue(1));
                        Assert.Equal(vv2, (sbyte)result.GetValue(2));
                        Assert.Equal(vv3, (short)result.GetValue(3));
                        Assert.Equal(vv4, (int)result.GetValue(4));
                        Assert.Equal(vv5, (long)result.GetValue(5));
                        Assert.Equal(vv6, (byte)result.GetValue(6));
                        Assert.Equal(vv7, (ushort)result.GetValue(7));
                        Assert.Equal(vv8, (uint)result.GetValue(8));
                        Assert.Equal(vv9, (ulong)result.GetValue(9));
                        Assert.Equal(vv10, (float)result.GetValue(10));
                        Assert.Equal(vv11, (double)result.GetValue(11));
                        Assert.Equal(Encoding.UTF8.GetBytes("b中文b"), result.GetValue(12));
                        Assert.Equal("n中文n", result.GetValue(13));
                        Assert.Equal(Encoding.UTF8.GetBytes("{\"a\":\"b\"}"), result.GetValue(14));
                    }
                }
                finally
